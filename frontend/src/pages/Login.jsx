    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#090C12] text-[#0F172A] dark:text-[#F8FAFC] flex flex-col font-sans transition-colors duration-200 relative overflow-hidden bg-cyber-grid selection:bg-amber-500 selection:text-black">
      ...
      <header className="w-full border-b border-slate-200/80 dark:border-slate-800/80 bg-white/85 dark:bg-[#0E1118]/85 backdrop-blur-md sticky top-0 z-30 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-slate-900 dark:bg-amber-500 flex items-center justify-center text-amber-400 dark:text-slate-950 font-black text-sm shadow-md shadow-amber-500/10 transition-transform hover:scale-105">
            <Zap className="w-4 h-4 fill-current" />
          </div>
          <div className="flex items-baseline gap-1.5">
            <span className="font-extrabold text-base tracking-tight font-heading text-slate-900 dark:text-white">MITRA</span>
            <span className="text-[11px] font-bold text-amber-600 dark:text-amber-400 tracking-widest uppercase font-mono">ATTENDANCE</span>
          </div>
        </div>
